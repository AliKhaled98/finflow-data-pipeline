"""
Silver Layer: Harmonizes and Merges FX Data.
- Loads latest official (API) and market (Scraped) data.
- Standardizes columns and calculates the raw variance.
- Saves a unified 'Hybrid' parquet file.
"""
import glob
import pandas as pd
import os
...
if latest_API and latest_scraped:
    ...
    # 4. CALCULATION & SCHEMA SELECTION
